...
public class UserRegistrationForm extends javax.swing.JPanel {
 JPanel bottomPanel;
    ...
    public UserRegistrationForm(JPanel bottomPanel) {
        initComponents();
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {
        try{ 
            ...
            if(userObject.getName().isBlank()) {
                ...
                UserViewDetails viewJPanelObject = new UserViewDetails(userObject);
    ...
    if (file.showSaveDialog(null) == JFileChooser.APPROVE_OPTION) {
        try {
            ...
            JOptionPane.showMessageDialog(this, "Please upload the correct image", "Error -  Wrong image", JOptionPane.ERROR_MESSAGE);
            ex.printStackTrace();
        }
    }
    }
